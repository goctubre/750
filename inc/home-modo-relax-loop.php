<div class="columns">
	...
	<div class="column">
		...
		<!--humor first- HUMOR-->
		<?php $the_query = new WP_Query( array('post_status' => 'publish', 'category_name'=>'relax','posts_per_page'=>1));?>
		...
		<div class="columns">
			<?php $the_query = new WP_Query( array( 'post_status' => 'publish', 'category_name' => 'humor', 'offset' => 1, 'posts_per_page' => 2 ) ); ?>
