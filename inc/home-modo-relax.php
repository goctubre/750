				...
				<div class="tabs rounded swipe_tabs">
					...
					<div class="swiper-container swiper-programacion filtromodo">
					  <div class="swiper-wrapper">
						<?php  $the_query = new WP_Query( array( 'post_status' => 'publish', 'post_status' => 'publish', 'post_type' => 'programas', 'posts_per_page' => 8)); ?>
				...
				<div class="swiperbox swiperbox-seccion">
					<div class="swiper-container swiper-secciones">
					  <div class="swiper-wrapper">
						<!-- loop entrevistas -->
						<?php 
							$the_query = new WP_Query( array( 'post_status' => 'publish', 'category_name' => 'entrevistas', 'posts_per_page' => 8));
						 ?>
				...
				<div class="swiperbox swiperbox-seccion">
					<div class="swiper-container swiper-secciones">
					  <div class="swiper-wrapper">
						<!-- loop audiocuentos -->
						<?php 
						$the_query = new WP_Query( array( 'post_status' => 'publish', 'category_name' => 'audiocuentos', 'posts_per_page' => 8));
						 ?>
			...
			<section id="deportes" class="is-seccion">
				...
				<div class="columns">
					...
					<?php 
						$the_query = new WP_Query( array( 'post_status' => 'publish', 'category_name' => 'deportes', 'posts_per_page' => 2 ) );
					?>
				...
				<div class="swiperbox swiperbox-seccion">
					<div class="swiper-container swiper-secciones">
					  <div class="swiper-wrapper">
						<!-- loop ENTREVISTAS -->
						<?php 
							$the_query = new WP_Query( array( 'post_status' => 'publish', 'category_name' => 'la-venganza-sera-terrible', 'posts_per_page' => 8));
						 ?>
