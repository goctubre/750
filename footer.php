...
?>
	...
	<footer class="footer is-bg-violet">
	  <div class="container">
	  	<div class="columns mt-5 has-text-centered">
	  		<div class="column">
	  			<img width="120" src="<?php echo get_template_directory_uri(); ?>/img/750am-logo-blanco.svg" alt="750 AM" />
	  		</div>
	  		<div class="column">
	  			<img style="margin-top: -8px" width="160" src="<?php echo get_template_directory_uri(); ?>/img/logo-grupo-octubre.png" alt="Grupo Octubre" />
	  		</div>
	  	</div>

	  	<br>
	  	<h5 class="is-size-5 has-text-weight-bold mt-4 mb-2 has-text-centered-mobile">Lo mejor de AM750 en tu mail </h5>
	  	...
	  	<div class="columns">
	  		<div class="column">
	  			<h5 class="is-size-5 has-text-weight-bold"> AM750 </h5> <br>
				Venezuela 370, <br>
				...
				<ul id="redesbottom" class="redes">
					...
					<a href="https://twitter.com/AM750" target="_blank" rel="noopener noreferrer"> 
						<li class="twitter-share">  <img src="<?php echo get_template_directory_uri(); ?>/img/s-twitter.svg" width="" height="" alt="AM750 Twitter" /> </li> 
					</a>

					<a href="https://api.whatsapp.com/send?phone=5491139224098" target="_blank" rel="noopener noreferrer">
						<li class="wp-share"> <img src="<?php echo get_template_directory_uri(); ?>/img/s-wa.svg" width="" height="" alt="AM750 WhatsApp" /> </li> 
					</a>
				</ul>
	  		...
	  		<div class="column">
	  			<h5 class="is-size-5 has-text-weight-bold">Diarios </h5> <br>
	  		...
	  		<div class="column">
	  			<h5 class="is-size-5 has-text-weight-bold">Publicaciones </h5> <br>
	  		...
	  		<div class="column">
	  			<h5 class="is-size-5 has-text-weight-bold">Radios </h5> <br>
	  			...
	  			<a href="https://mucharadio.com.ar/" target="_blank" rel="noopener noreferrer" >Mucha Radio</a> <br> 
	  			...
	  			<a href="https://cluboctubre947.com/" target="_blank" rel="noopener noreferrer" >Club 947</a>
	  		</div>

	  		<div class="column">
	  			<h5 class="is-size-5 has-text-weight-bold">Contenidos </h5> <br>
	...
	<a id="gototop" class="is-bg-celeste">
		<img src="<?php echo get_template_directory_uri(); ?>/img/chevron-up.svg" width="" height="" alt="Ir hacia arriba" />
	</a>


	<!--Player-->
	<div data-msp data-type='live' data-id='601bf3e463786007e6d3b9b0' data-player='603416a7b108a9485c0be15f'><script type='text/javascript' src='https://player.cdn.mdstrm.com/lightning_player/api.js'></script></div>
	<!--player-->
