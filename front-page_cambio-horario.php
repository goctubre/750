		...
		<div class="columns">
			...
			<div class="column">
				<div class="columns is-mobile">
				  <div class="column is-2-desktop is-3-mobile has-text-centered-mobile">
				  	<br>
					<a href="<?php echo get_site_url(); ?>/bajate-nuestra-app/"> <img src="<?php echo get_template_directory_uri(); ?>/img/accesos-rapidos-app.svg" width="" height="" alt="750 AM" /> </a>
				  </div>
				  <div class="column">
					<a href="<?php echo get_site_url(); ?>/bajate-nuestra-app/"> <p class="has-text-weight-bold mb-3">Bajate nuestra app</p>
