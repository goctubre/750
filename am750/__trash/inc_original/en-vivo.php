...
<?php if( $the_query->have_posts() ): ?>
	<?php while ( $the_query->have_posts() ) : $the_query->the_post(); 
		...
		<div class="columns" id="en-vivo-bloque">
			...
			<div class="column is-7"> <a href="<?php the_permalink($programa_id); ?>"> <?php echo get_the_post_thumbnail( $programa_id, 'large', array( 'class' => 'is-bordeado' ) ); ?> </a> </div>
			...
			<div class="column has-text-centered-mobile">
				...
				<h2 class="is-size-4 mb-5"> <?php echo get_the_title($programa_id)?> </h2>
