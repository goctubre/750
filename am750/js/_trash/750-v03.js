/// MAJO 11-05-2021
// OPEN MENU & MANTO > LO METÍ EN ACTIVAR BOTONES Y LO PASÉ A JS CHECKEAR
// 01- PASAR TODO ACTIVAR_BOTONES A FINAL
...
(function() {
  ...
  function backToTop() {
    if (window.pageYOffset > 0) { window.scrollBy(0, -80); setTimeout(backToTop, 0);}  
  }
...
function activar_botones(){
  ...
  jQuery("body").on("click touch", ".switch", function() { 
    ...
    //ELIMINAR ESTO
    //jQuery("html").removeClass("overhidden");
    ...
    //   jQuery("#manto").removeClass("show");
    //   jQuery("#menuprincipal").removeClass("is-active");
    //   jQuery(".openmenu .burger").removeClass("is-active");/*ARREGLADO  MENU NUEVO MAJO*/
    //   jQuery("html").removeClass("overhidden"); /*AGREGUE MENU NUEVO MAJO*/
