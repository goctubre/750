...
function alert_settings_callback_function() { echo '<p>Máximo 110 caracteres</p>'; }

function alertas_input() { ?>
    <label for="my-input"> <?php //_e( 'Ahora / Urgente' ); ?> </label>
    <input maxlength="110" style="width:500px" type="text" id="breaking_news_field" name="breaking_news_field" value="<?php echo get_option('breaking_news_field'); ?>">
    <?php
}
